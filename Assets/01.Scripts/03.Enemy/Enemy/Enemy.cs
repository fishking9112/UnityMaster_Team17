...
public class Enemy : MonoBehaviour
{
    ...
    public void ShootRiffle()
    {
        ...
        Quaternion targetRotation = Quaternion.LookRotation((GameManager.Instance.player.transform.position - EnemyShootPosition.transform.position).normalized);
        bullet.transform.rotation = Quaternion.Slerp(EnemyShootPosition.transform.rotation, targetRotation, stateMachine.RotationDamping * 2 * Time.deltaTime);
